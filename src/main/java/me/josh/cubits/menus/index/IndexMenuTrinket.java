...
public class IndexMenuTrinket {


    private static final  String ERROR_COLOR = "&c";
    private static final int ITEMS_PER_PAGE = 28;

    private IndexMenuTrinket(){
    }

    public static void OpenIndexMenuTrinket(Main plugin, Player p, int page) {
        ...
        // Create Inventory
        Inventory gui = Bukkit.createInventory(p, 54, "Trinket Index - Page " + page);
        ...
        int databaseSize = CubitDatabase.getDummyItemDatabase().size(); //CHANGE HERE AND A FEW PLACES BELOW
        ...
        for (int i = (page - 1) * 28; i < 28 * page; i++) {
            ...
            ItemBase item;
            item = CubitDatabase.getDummyItemDatabase().get(i);

//            if(i < CubitDatabase.getCosmeticItemDatabase().size()){
//            }
