...
public class AchievementMenu extends CubitGui {
    ...
    public static void openAchievementMenu(Main plugin, Player p) {
        ...
        loreInt3 = playerProfile.getPlayerVariables().get(PlayerVariables.ACHIEVEMENT_TYPE_1);
        loreInt4 = playerProfile.getPlayerVariables().get(PlayerVariables.ACHIEVEMENT_ID_1);
