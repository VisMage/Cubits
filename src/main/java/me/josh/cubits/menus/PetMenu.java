...
public class PetMenu extends CubitGui {
    private static final int INVENTORY_SIZE = 54;
    private static final String INVENTORY_NAME = ChatColor.DARK_PURPLE + "Cubits - page ";
    ...
    private static final ItemStack UNEQUIP_ICON;
    ...
    static {
        ...
        UNEQUIP_ICON = new ItemStack(Material.LEAD);
        ItemMeta unequipMeta = UNEQUIP_ICON.getItemMeta();
        unequipMeta.setDisplayName(ChatColor.LIGHT_PURPLE + "Unequip Cubit");
        UNEQUIP_ICON.setItemMeta(unequipMeta);

        PICKUP_ICON = new ItemStack(Material.NETHER_STAR);
        ItemMeta pickupMeta = PICKUP_ICON.getItemMeta();
        pickupMeta.setDisplayName(ChatColor.LIGHT_PURPLE + "Rebirth");
        ArrayList<String> loreRebirth = new ArrayList<>();
        loreRebirth.add("Merge duplicate pets to inherit highest grade.");
        loreRebirth.add("Coming soon!");
    ...
    public static void OpenPetMenu(Main plugin, Player player, int page){
        ...
        gui.setItem(47, UNEQUIP_ICON);
        gui.setItem(51, PICKUP_ICON);
