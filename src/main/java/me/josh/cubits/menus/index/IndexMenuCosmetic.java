...
public class IndexMenuCosmetic {

    private static final  String ERROR_COLOR = "&c";
    private static final int ITEMS_PER_PAGE = 28;

    private IndexMenuCosmetic(){
    }

    public static void OpenIndexMenuCosmetic(Main plugin, Player p, int page) {
        ...
        // Create Inventory
        Inventory gui = Bukkit.createInventory(p, 54, "Cosmetic Index - Page " + page);
        ...
        int databaseSize = CubitDatabase.getCosmeticItemDatabase().size();
        ...
        for (int i = (page - 1) * 28; i < 28 * page; i++) {
            ...
            ItemBase item;
            item = CubitDatabase.getCosmeticItemDatabase().get(i);
