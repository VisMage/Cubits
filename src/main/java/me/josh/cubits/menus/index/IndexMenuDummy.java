...
public class IndexMenuDummy {

    private static final  String ERROR_COLOR = "&c";
    private static final int ITEMS_PER_PAGE = 28;

    private IndexMenuDummy(){
    }

    public static void OpenIndexMenuDummy(Main plugin, Player p, int page) {
        ...
        // Create Inventory
        Inventory gui = Bukkit.createInventory(p, 54, "Item Index - Page " + page);
        ...
        int databaseSize = CubitDatabase.getDummyItemDatabase().size();
